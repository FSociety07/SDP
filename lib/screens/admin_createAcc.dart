...
import 'package:pickngo/model/rider_model.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:pickngo/screens/admin_home.dart';

class riderRegistration extends StatefulWidget {
  const riderRegistration({Key? key}) : super(key: key);

  @override
  _riderRegistrationState createState() => _riderRegistrationState();
}
...
class _riderRegistrationState extends State<riderRegistration> {
  ...
  postDetailsToFireStore() async {
    ...
    riderModel.email = user!.email;
    riderModel.uid = user.uid;
    riderModel.firstName = firstEditingController.text;
    riderModel.secondName = secondEditingController.text;
    riderModel.role = "rider";

    await firebaseFirestore
        .collection("users")
        .doc(user.uid)
        .set(riderModel.toMap());
